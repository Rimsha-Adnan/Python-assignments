...
def main():
    user_input = input(PROMPT).strip().lower()  # Ask the user for input and clean it up

    if user_input == "joke":  # If the user types "joke", print the joke
        print(JOKE)
    else:  # If the user types anything else, print the sorry message
        print(SORRY)
